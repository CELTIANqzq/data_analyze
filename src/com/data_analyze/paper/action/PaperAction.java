...
public class PaperAction {
    ...
    public String insert() throws Exception {
        ...
        if (count == 1) {
            ...
            File teacherTable = new File("/Users/liujie/Desktop/data_analyze/conf/2015_papers_table.xlsx");

            paperService.importPaper(teacherTable, ".xlsx", 2015);

            teacherTable = new File("/Users/liujie/Desktop/data_analyze/conf/2016_papers_table.xlsx");
